...
<html>
    ...
    <body style=' margin: 5%;'>
        ...
        <table >
            ...
            <?php $id = $_GET["product"] ?>
            <?php print("<form action='stap1_productbestelling.php?action=extras&id=$id'  method='POST'>"); ?>
            ...
            ?>                                   
                ...
                <?php print("<a href='stap1_productbestelling.php'><input type='button' value='Annuleren'></a>") ?>
